    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('delete', function ($query) {
                return '<a href="#" data-id="'.$query->id.'" data-name="'.$query->name.'" data-guardName="'.$query->guard_name.'" class="btn btn-danger showDeleteModel" data-toggle="modal" data-target="#delete-permission"><i class="fa fa-eye"></i> Delete</a>';
            })
            ->rawColumns([
                'edit',
                'delete',
...
//            ->setTableId('role-table')
            ...
            ->parameters([
                ...
                'buttons'      => [
                    [
                        'text' => '<i class="fa fa-plus"></i> ' . 'Add Permission',
